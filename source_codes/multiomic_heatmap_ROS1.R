...
ht1 <- Heatmap(mat_rna,
               ...
               row_title = "RNAseq",
               column_title = "Multiomic_Heatmap_ROS1",
               name = "Z-score", 
               column_split = Split,
               # cluster_rows = FALSE,
...
proteomic
# write.table(proteomic,"list_MOFA_ROS1_cluster_RNA.txt",sep="\t",row.names=FALSE)
...
proteomic
# write.table(proteomic,"list_MOFA_ROS1_cluster_PROT.txt",sep="\t",row.names=FALSE)
...
proteomic
# write.table(proteomic,"list_MOFA_ROS1_cluster_PHOSPHO.txt",sep="\t",row.names=FALSE)
